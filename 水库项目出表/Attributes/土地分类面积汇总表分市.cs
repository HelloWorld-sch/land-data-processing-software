    ...
    public partial class Export
    {
        public void 土地分类面积汇总表分市(string unit)
        {
            ...
            try
            {
                ...
                (from b in tjTable.AsEnumerable() orderby b.Field<string>("市州"), b.Field<string>("县") descending, b.Field<string>("权属性质") descending, b.Field<string>("乡镇") descending, b.Field<string>("村") descending, b.Field<string>("组") descending, b.Field<int>("权重") select b).CopyToDataTable(resultTable,LoadOption.OverwriteChanges);
